    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-tr from-sara-pastel3/40 via-background to-sara-pastel2/40 p-4 sm:p-8 overflow-x-hidden relative">
      <div className="relative w-full max-w-4xl z-10">
        ...
        >
          <Link 
            to="/saranterest"
            className="interactive-tile-small bg-sara-retro1/10 relative overflow-hidden group"
          >
            ...
            <div className="relative z-10 p-3 text-center">
              ...
              <h2 className="text-base font-pixel font-semibold truncate pixel-shadow">Saranterest</h2>
            </div>
          </Link>

          <Link 
            to="/googolu"
            className="interactive-tile-small bg-sara-retro2/10 relative overflow-hidden group"
          >
            ...
            <div className="relative z-10 p-3 text-center">
              ...
              <h2 className="text-base font-pixel font-semibold truncate pixel-shadow">Googolu</h2>
            </div>
          </Link>

          <Link 
            to="/saratify"
            className="interactive-tile-small bg-sara-retro3/10 relative overflow-hidden group"
          >
            ...
            <div className="relative z-10 p-3 text-center">
              ...
              <h2 className="text-base font-pixel font-semibold truncate pixel-shadow">Saratify</h2>
            </div>
          </Link>

          <Link 
            to="/saraprise"
            className="interactive-tile-small bg-sara-retro5/10 relative overflow-hidden group"
          >
            ...
            <div className="relative z-10 p-3 text-center">
              ...
              <h2 className="text-base font-pixel font-semibold truncate pixel-shadow">Saraprise</h2>
            </div>
          </Link>
        </div>
      </div>
