...
const Saraprise = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-sara-pink/20 via-background to-sara-purple/20">
      <div className="container py-8">
        ...
        <div className="max-w-screen-sm mx-auto glass p-4 shadow-lg animate-fade-in rounded-sm px-0 py-0">
          ...
          <iframe src="./assets/index_saraprise.html" title="Saraprise Content" className={`relative w-full h-full rounded-lg transition-opacity duration-500 ${isIframeLoading ? "opacity-0" : "opacity-100"}`} onLoad={handleIframeLoad} style={{
          overflow: "auto",
          border: "none"
        }}></iframe>
