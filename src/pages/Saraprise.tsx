...
const Saraprise = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-sara-pink/20 via-background to-sara-purple/20">
      <div className="container py-8">
        ...
        <div className="max-w-screen-sm mx-auto glass p-4 shadow-lg animate-fade-in rounded-sm">
          ...
          {isIframeLoading && <div className="w-full h-[400px] flex flex-col items-center justify-center rounded-lg bg-black/5 backdrop-blur-sm">
          ...
          <div className="relative w-full h-full rounded-lg overflow-hidden shadow-lg border border-muted bg-gradient-to-br from-sara-pink/10 via-background to-sara-purple/10">
            <iframe src="./assets/index_saraprise.html" title="Saraprise Content" className={`relative w-full min-h-[400px] rounded-lg transition-opacity duration-500 ${isIframeLoading ? "opacity-0" : "opacity-100"}`} onLoad={handleIframeLoad} style={{
              border: "none",
              height: "60vh"
            }} />
            {!isIframeLoading && <div className="absolute inset-0 pointer-events-none border-2 border-primary rounded-lg animate-glow">
          ...
          <div className="mt-8 text-center px-4">
            ...
            <p className="text-lg mt-6 text-zinc-950 font-semibold">
